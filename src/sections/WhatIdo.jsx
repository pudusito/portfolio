...
export default function WhatIdo() {
  ...
  return (
    <>
      <div className="relative w-full h-full py-6 sm:py-8 md:py-12 bg-white/10">
        
        {/* Main Title and Description */}
        <div ref={whatRef} className="text-black tracking-wide leading-relaxed text-center px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        <div className="flex flex-wrap justify-center items-stretch mt-8 sm:mt-12 md:mt-16 lg:mt-20 px-4">
          <div ref={skillsRef} className="text-black tracking-wide leading-relaxed border-2 rounded-lg shadow-lg bg-white/5 w-full max-w-xs sm:max-w-sm md:max-w-md">       
            ...
            <div className="text-sm sm:text-base md:text-lg lg:text-xl p-3 sm:p-4 md:p-6 neon-border space-y-1 sm:space-y-2">
              <div> Full Stack</div>
